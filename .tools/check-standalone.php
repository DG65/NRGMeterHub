<?php
/**
 * check-standalone.php — Prüft die Eigenständigkeit dieses Moduls (MeterHub).
 *
...
// Präfixe der Partnermodule. MHUB/MHUBD sind die EIGENEN Präfixe dieses Repos
// und gehören daher NICHT in die Liste — sonst meldet das Skript die eigenen
// Funktionen als ungeschützte Fremdaufrufe.
const FOREIGN_PREFIXES = ['IHUB', 'IHUBD', 'IHUBNRG', 'IHUBMON', 'IHUBTILE', 'PVF', 'HEISHA', 'SGW', 'TIBBERGR', 'TESSIE', 'EMS', 'GWET'];
